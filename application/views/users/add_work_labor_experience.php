                  ...
                  <div class="progresscontainer">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h3 class="panel-title">VI. Work/Labor Experience</h3>
                        </div>
                        <div class="panel-body">
                          <form id="work" method="POST" action="<?= base_url(); ?>lgu/members/add/work_labor_experience/save/<?= $id; ?>">
                            ...
                            <table id="work" class="table">
                              <tr>
                                <td style="border:none;" class="inp">
                                  ...
                                  <input type="text" id="workDate" name="workDate[]" class="form-control"placeholder="Select Date" autocomplete="off">
                                </td>
                                <td style="border:none;" class="inp">
                                  <label>Job Title</label>
                                  <input type="text" name="jobTitle[]" class="form-control" placeholder="Enter Job Title" maxlength="40">
                                </td>
                                <td style="border:none;" class="inp">
                                  <label>Monthly Income</label>
                                  <input type="number" name="monIncome[]" class="form-control" placeholder="Enter Monthly Income" maxlength="5">
                                </td>
                                <td style="border:none;" class="inp">
                                  <label>Reason for Leaving</label>
                                  <input type="text" name="reLeave[]" class="form-control" placeholder="Enter Reason" maxlength="40">
                                </td>
                              </tr>
                            </table>
