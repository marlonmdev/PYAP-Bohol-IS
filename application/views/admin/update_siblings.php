                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Add Siblings (brothers/sisters)</h3>
                        </div>
                        <div class="panel-body">
                          <form id="siblings" method="POST" action="<?= base_url(); ?>admin/members/view/siblings/add/save/<?= $id; ?>">
                            ...
                            <table id="siblings" class="table table-responsive">
                              <tr>
                                <td style="border:none;" class="inp" colspan="2">
                                  <label>Name</label>
                                  <input type="text" name="sibName[]" class="form-control" placeholder="Enter Name" maxlength="60" required/>
                                </td>
                                ...
                                <td style="border:none;" class="inp" width="10%">
                                  <label>Age</label>
                                  <input type="number" name="sibAge[]" class="form-control" placeholder="Age" maxlength="2" required/>
                                </td>
                                <td style="border:none;" class="inp" width="20%">
                                  <label>Occupation</label>
                                  <input type="text" name="sibOccup[]" class="form-control" placeholder="Enter Occupation" maxlength="30" required/>
                                </td>
                                <td style="border:none;" class="inp">
                                  <label>Grade/Year</label>
                                  <input type="text" name="sibGrYr[]" class="form-control" placeholder="Enter Grade/Year" maxlength="30" required/>
                                </td>
                                <td style="border:none;" class="inp" width="10%">
                                  <label>ISY/OSY</label>
