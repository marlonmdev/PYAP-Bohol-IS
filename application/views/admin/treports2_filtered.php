                        ...
                        <div class="table-responsive" id="data">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    ...
                                    <tr id="trHead">
                                        <th id="vHeader" style="font-size:.9em;">None</th>
                                        <th id="vHeader" style="font-size:.9em;">Agriculture/ Farming</th>
                                        <th id="vHeader" style="font-size:.9em;">Technician/ Repair</th>
                                        <th id="vHeader" style="font-size:.9em;">Construction</th>
                                        <th id="vHeader" style="font-size:.9em;">Singing</th>
                                        <th id="vHeader" style="font-size:.9em;">Dancing</th>
                                        <th id="vHeader" style="font-size:.9em;">Carpentry</th>
                                        <th id="vHeader" style="font-size:.9em;">Computer</th>
                                        <th id="vHeader" style="font-size:.9em;">Drawing/ Painting</th>
                                        <th id="vHeader" style="font-size:.9em;">Dressmaking/ Tailoring</th>
                                        <th id="vHeader" style="font-size:.9em;">Sports</th>
                                        <th id="vHeader" style="font-size:.9em;">Arts</th>
                                        <th id="vHeader" style="font-size:.9em;">Playing Musical Instrument</th>
                                        <th id="vHeader" style="font-size:.9em;">Business/ Entrepreneurship</th>
                                        <th id="vHeader" style="font-size:.9em;">Swimming</th>
                                        <th id="vHeader" style="font-size:.9em;">Writing</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
