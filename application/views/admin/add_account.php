                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form id="acForm" method="POST" action="<?= base_url(); ?>admin/accounts/add/save" enctype="multipart/form-data" class="form-horizontal"><!-- START OF FORM -->
                                            <div class="row form-group">
                                                <div class="inp col-md-4">
                                                    <label>Name</label>
                                                    <input type="text" name="name" class="form-control" maxlength="60" placeholder="Enter Full Name" required/>
                                                </div>
                                                <div class="inp col-md-3">
                                                    <label>Position</label>
                                                    <input type="text" name="position" class="form-control" maxlength="30" placeholder="Position" required/>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="inp col-md-4">
                                                    ...
                                                    <input type="text" id="phone" name="phone" class="form-control" minlength="11" maxlength="11" placeholder="Enter Phone Number" onkeyup="clean()" onkeydown="clean()" required/>
                                                </div>
                                                <div class="inp col-md-4">
                                                    <label>Email</label>
                                                    <input type="email" name="email" class="form-control" maxlength="30" placeholder="Enter Email Address" required/>
                                                </div>
                                                <div class="inp col-md-4">
                                                    <label>User Name</label>
                                                    <input type="text" name="uname" class="form-control" maxlength="15" placeholder="Enter Username" required/>
                                                </div>
                                            </div>    
                                            <div class="row form-group">
                                                <div class="inp col-md-4">
                                                ...
                                                <div class="inp col-md-4">
                                                    ...
                                                    <input type="password" id="pword1" name="pword1" class="form-control" minlength="6" placeholder="Enter password" required>
                                                    <input type="checkbox" onclick="showPword()"> <label>Show Password</label><br><br>
                                                    <label>Confirm Password</label>
                                                    <input type="password" id="pword2" name="pword2" class="form-control" placeholder="Confirm password" required>
                                                </div>
                                            </div>   
                                            <div class="row">
                                                <div class="col-md-12">
