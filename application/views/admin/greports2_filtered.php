        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?= base_url(); ?>admin/graphical_reports/highest_educational_attainment_report">Educational Background</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-10">
                                <form id="repForm" method="POST" action="<?= base_url(); ?>admin/graphical_reports/highest_educational_attainment_report/filter">
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div id="data">
                            ...
                            <?php 
                                if($repType == 'Quarter'){
                                    ...
                                    echo "<center><h4>".$quarter." Quarter Educational Background Report, CY ".$fYear."</h4></center>";
                                }else{
                                    echo "<center><h4>Annual Educational Background Report, CY ".$fYear."</h4></center>";
                                }
                            ?>
                            <br>
                            ...
                            <div id='myChart' style="margin-top:20px;height:auto;width:100%;min-height:350px;"></div>
                            <br>
