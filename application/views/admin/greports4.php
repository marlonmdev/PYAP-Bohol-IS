            ...
            Morris.Bar({
                ...
                data: [
                    <?php 
                        ...
                        echo "{ a: '$row->municipal', b: '$row->m_members' },";
                        } 
                    ?>
                ],
                xkey: 'a',
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="<?= base_url(); ?>admin/graphical_reports">Municipality Members</a></li>
                    <li role="presentation"><a href="<?= base_url(); ?>admin/graphical_reports/age_brackets_report">Age Brackets</a></li>
                    <li role="presentation"><a href="<?= base_url(); ?>admin/graphical_reports/highest_educational_attainment_report">Highest Educational Attainment</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-10">
                                <form id="repForm" method="POST" action="<?= base_url(); ?>admin/graphical_reports/filter">
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div id="data">
                            ...
                            <?php 
                                ...
                                echo "<center><h4>".$quarter." Quarter Municipality Members Report, CY ".$yr."</h4></center>"
                            ?>
                            <div id='myChart' style="margin-top:20px;height:auto;width:100%;min-height:450px;"></div>
                            <br>
