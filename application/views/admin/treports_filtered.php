                        ...
                        <div class="table-responsive" id="data">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    if(empty($content)){   
                                        echo '<td colspan="18"><strong><h3 class="text-center"><span class="ti-face-sad"></span> No Data Found..</h3></strong></td>'; 
                                    }elseif(!empty($content)){
                                        foreach($content as $row){
                                    ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url(); ?>admin/tabular_reports/breakdown/<?= $row->municipal; ?>/<?= $row->mun_id ?>/<?= $quart ?>/<?= $fYear ?>" style="text-decoration: none;" title="Click to show municipality information"><?= $row->municipal; ?></a></td>
