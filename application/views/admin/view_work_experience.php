                    ...
                    <div class="row">
                        <div class="col-lg-12"><br>
                            <ol class="breadcrumb" style="border-radius:0px;">
                              ...
                              <li class="active" style="font-size: 1.2em;">Work Experience</li>
                            </ol>
                            <h4><label><?php echo $info->fName.' '.$info->mName.' '.$info->lName.' '.$info->ext ?>'s Work Experience</label></h4>
                            <a href="<?= base_url(); ?>admin/members/view/barangays/<?= $mun_id ?>" class="btn btn-warning pull-left">Back</a>&nbsp;
                            <a href="<?= base_url(); ?>admin/members/view/work_experience/add/<?= $id; ?>" class="btn btn-primary">Add</a><br><br>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url(); ?>admin/members/edit/work_experience/<?= $row->id; ?>" class="btn btn-success" title="Edit"><span class="ti-pencil-alt"></span></a>
                                                <a onclick="deleteWork(<?= $row->id; ?>)" class="btn btn-danger" title="Delete"><span class="ti-trash"></span></a>
                                            </td>          
                                        </tr>
                                         <?php   
                                            }
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius:0px;">
              ...
              <div class="modal-body">
                <h4 class="text-center"><span style="color:#D2322D!important;" class="ti-help-alt"></span>&nbsp; Are you sure to delete member's work experience?</h4>
              </div>
