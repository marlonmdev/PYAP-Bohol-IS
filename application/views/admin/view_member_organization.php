                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12"><br>
                            ...
                            <a href="<?= base_url(); ?>admin/members/view/member_organization/add/<?= $id; ?>" class="btn btn-primary">Add</a><br><br>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url(); ?>admin/members/edit/member_organization/<?= $row->id; ?>" class="btn btn-success" title="Edit"><span class="ti-pencil-alt"></span></a>
