        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?= base_url(); ?>admin/tabular_reports/reason_for_dropping_report">Reason for Dropping</a></li>
                    <li role="presentation"><a href="<?= base_url(); ?>admin/tabular_reports/interest_hobbies_report">Interest/Hobbies</a></li>
                </ul><br>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-10">
                                <form id="repForm" method="POST" action="<?= base_url(); ?>admin/tabular_reports/reason_for_dropping_report/filter">
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div class="table-responsive" id="data">
                            ...
                            <?php 
                                if($repType == 'Quarter'){
                                    ...
                                    echo "<center><h4>".$quarter." Quarter Reason for Dropping Report, CY ".$fYear."</h4></center>";
                                }else{
                                    echo "<center><h4>Annual Reason for Dropping Report, CY ".$fYear."</h4></center>";
                                }
                            ?>
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    if(empty($content)){   
                                        echo '<td colspan="6"><strong><h3 class="text-center"><span class="ti-face-sad"></span> No Data Found..</h3></strong></td>'; 
                                    }elseif(!empty($content)){
                                        foreach($content as $row){
                                    ?>
                                    <tr>
                                        <td class="text-center"><?= $row->municipal; ?></td>
                                        <td class="text-center"><?= $row->m_reason1; ?></td>
                                        <td class="text-center"><?= $row->m_reason2; ?></td>
                                        <td class="text-center"><?= $row->m_reason3; ?></td>
                                        <td class="text-center"><?= $row->m_reason4; ?></td>
                                        <td class="text-center"><?= $row->m_reason5; ?></td>
                                    </tr>
                                     <?php   
                                        }
                                        }
