                        ...
                        <div class="table-responsive" id="data">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td class="text-center"><a href="<?= base_url(); ?>admin/tabular_reports/members/<?= $mun->municipal; ?>/<?= $row->brgy_id; ?>" style="text-decoration: none;" title="Click to show members"><?= $row->brgy; ?></a></td>
