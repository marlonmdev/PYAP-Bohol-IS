        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="<?= base_url(); ?>admin/tabular_reports/interest_hobbies_report">Interest/Hobbies</a></li>
                     <!-- <li role="presentation"><a href="">Reason for Dropping Report</a></li> -->
                </ul><br>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-10">
                                <form id="repForm" method="POST" action="<?= base_url(); ?>admin/tabular_reports/interest_hobbies_report/filter">
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        <div class="table-responsive" id="data">
                            ...
                            <?php 
                                if($repType == 'Quarter'){
                                    ...
                                    echo "<center><h4>".$quarter." Quarter Interest/Hobbies Report, CY ".$fYear."</h4></center>";
                                }else{
                                    echo "<center><h4>Annual Interest/Hobbies Report, CY ".$fYear."</h4></center>";
                                }
                            ?>
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="7" class="text-center">INTEREST/HOBBIES</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center">Internet Surfing</th>
                                        <th class="text-center">Watching TV</th>
                                        <th class="text-center">Sports</th>
                                        <th class="text-center">Music</th>
                                        <th class="text-center">Arts</th>
                                        <th class="text-center">Singing</th>
                                        <th class="text-center">Dancing</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if(empty($content)){   
                                        echo '<td colspan="8"><strong><h3 class="text-center"><span class="ti-face-sad"></span> No Data Found..</h3></strong></td>'; 
                                    }elseif(!empty($content)){
                                        foreach($content as $row){
                                    ?>
                                    <tr>
                                        <td class="text-center"><?= $row->municipal; ?></td>
                                        <td class="text-center"><?= $row->m_interest1; ?></td>
                                        <td class="text-center"><?= $row->m_interest2; ?></td>
                                        <td class="text-center"><?= $row->m_interest3; ?></td>
                                        <td class="text-center"><?= $row->m_interest4; ?></td>
                                        <td class="text-center"><?= $row->m_interest5; ?></td>
                                        <td class="text-center"><?= $row->m_interest6; ?></td>
                                        <td class="text-center"><?= $row->m_interest7; ?></td>
                                    </tr>
                                     <?php   
                                        }
                                        }
