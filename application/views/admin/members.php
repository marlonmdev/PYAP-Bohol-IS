                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="multi-level">
                            <?php 
                                ...
                                {
                            ?>
                                <a href="<?= base_url() ?>admin/members/view/barangays/<?= $row->mun_id; ?>" style="text-decoration:none;">
                                    <div class="well" style="color:#333;margin-bottom:2px;padding:12px 15px;border-radius:0px;background:#fff!important;" title="Click to view barangays">
                                        <label for="<?= $row->municipal; ?>"><span style="color:#2A81DD;font-weight:bold;"><?= $row->municipal; ?></span>  &nbsp;&nbsp; | &nbsp;&nbsp; # of Youth: <?= $row->m_youth ?> &nbsp;&nbsp; | &nbsp;&nbsp; # of OSY: <?= $row->m_osy ?> &nbsp;&nbsp; Male: <?= $row->m_osy_m ?> &nbsp;&nbsp; Female: <?= $row->m_osy_f ?> &nbsp;&nbsp; | &nbsp;&nbsp; # of ISY: <?= $row->m_isy ?> &nbsp;&nbsp; Male: <?= $row->m_isy_m ?> &nbsp;&nbsp; Female: <?= $row->m_isy_f ?>  &nbsp;&nbsp; | &nbsp;&nbsp; Solo Parent: <?= $row->m_solo ?></label>
                                    </div>
                                </a>
                            <?php } ?>
                        </div>
