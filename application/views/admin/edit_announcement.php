                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form id="anForm" action="<?= base_url(); ?>admin/announcements/edit/update/<?= $row->id; ?>" method="POST" class="form-horizontal">
                                            <div class="inp row form-group">
                                                <div class="col-md-12">
                                                    <label>Title</label>
                                                    <input type="text" name="title" class="form-control" value="<?= $row->title; ?>" placeholder="Enter Title" maxlength="60" required/>
                                                </div>
                                            </div>
                                            <div class="inp row form-group">
                                                <div class="col-md-12">
                                                    <label>Description</label>
                                                    <textarea class="form-control" rows="8" name="descr" placeholder="Enter description" required><?= $row->descr; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
