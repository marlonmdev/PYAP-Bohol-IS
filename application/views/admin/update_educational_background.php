              ...
              <div class="col-lg-12">
                  ...
                  <div class="panel panel-default">
                      <div class="panel-heading">
                          <h3 class="panel-title">Update Educational Background</h3>
                      </div>
                      <div class="panel-body">
                        <form id="education" method="POST" action="<?= base_url(); ?>admin/members/update/educational_background/update/<?= $id; ?>">
                          <h5><strong>E L E M E N T A R Y &nbsp; L E V E L</strong></h5>
                          <div class="row form-group">
                            <div class="inp col-md-3">
                                <label>School Name</label>
                                <input type="text" name="eName" class="form-control" placeholder="Enter School Name" maxlength="50" required>
                            </div>
                            <div class="inp col-md-4">
                                <label>School Address</label>
                                <input type="text" name="eAddr" class="form-control" placeholder="Enter School Address" maxlength="50" required>
                            </div>
                          ...
                          <div class="row form-group">
                            <div class="inp col-md-3">
                              ...
                              <input type="text" id="eFrom" name="eFrom" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                            <div class="inp col-md-3">
                              <label>To <span class="text-success">(Optional)</span></label>
                              <input type="text" id="eTo" name="eTo" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                          ...
                          <div class="row form-group">
                            <div class="col-md-3">
                              <label>School Name</label>
                                <input type="text" name="sName" class="form-control" placeholder="Enter School Name" maxlength="50">
                              </div>
                            <div class="col-md-4">
                              <label>School Address</label>
                                <input type="text" name="sAddr" class="form-control" placeholder="Enter School Address" maxlength="50">
                              </div>
                            <div class="col-md-2">
                              <label>Grade Level</label>
                              <select name="sLevel" class="form-control">
                                ...
                                <option value="Grade 2">Grade 8</option>
                                <option value="Grade 3">Grade 9</option>
                                <option value="Grade 4">Grade 10</option>
                                <option value="Grade 5">Grade 11</option>
                          ...
                          <div class="row form-group">
                            <div class="col-md-3">
                              <label>From <span class="text-success">(Optional)</span></label>
                              <input type="text" id="sFrom" name="sFrom" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                            <div class="col-md-3">
                              <label>To <span class="text-success">(Optional)</span></label>
                              <input type="text" id="sTo" name="sTo" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                          ...
                          <div class="row form-group">
                            <div class="col-md-3">
                              <label>School Name</label>
                                <input type="text" name="cName" class="form-control" placeholder="Enter School Name" maxlength="50">
                            </div>
                            <div class="col-md-4">
                              <label>School Address</label>
                                <input type="text" name="cAddr" class="form-control" placeholder="Enter School Address" maxlength="50">
                            </div>
                            <div class="col-md-2">
                          ...
                          <div class="row form-group">
                            <div class="col-md-6">
                              <label>Degree/Course</label>
                                <input type="text" name="cDegree" class="form-control" placeholder="Enter degree/course" maxlength="60">
                            </div>
                            <div class="col-md-3">
                              <label>From <span class="text-success">(Optional)</span></label>
                              <input type="text" id="cFrom" name="cFrom" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                            <div class="col-md-3">
                              <label>To <span class="text-success">(Optional)</span></label>
                              <input type="text" id="cTo" name="cTo" class="form-control" placeholder="Select Date" autocomplete="off">
                            </div>
                          </div>
