        ...
        <script type="text/javascript">
            $(function () {
                var $arrColors = ['#3191CE', '#EE0539', '#24CE7F', '#AB34D3', '#C7B82B'];
                Morris.Bar({
                    element: 'myChart',
                    data: [
                        { a: 'Financial Problem', b: <?= $reason1; ?> }, 
                        { a: 'Not Interested', b: <?= $reason2; ?> }, 
                        { a: 'Family Problem', b: <?= $reason3; ?> }, 
                        { a: 'Early Pregnancy', b: <?= $reason4; ?> },
                        { a: 'Health Problems', b: <?= $reason5; ?> }, 
                    ],
                    xkey: 'a',
                    ykeys: ['b'],
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?= base_url(); ?>lgu/graphical_reports/reason_for_dropping_report">Reason for Dropping</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-10">
                                    <form id="repForm" method="POST" action="<?= base_url(); ?>lgu/graphical_reports/reason_for_dropping_report/filter">
                                        <div class="row">
                                            <div class="col-md-3">
