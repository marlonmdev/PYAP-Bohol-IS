      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12"><br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4><label><?php echo $info->fName.' '.$info->mName.' '.$info->lName.' '.$info->ext ?>'s Interest/Hobbies</label></h4><br>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Update Interest/Hobbies</h3>
                        </div>
                        <div class="panel-body">
                          <form method="POST" action="<?= base_url(); ?>lgu/members/add/interest_hobbies/update/<?= $id; ?>">
