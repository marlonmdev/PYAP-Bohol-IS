            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?= base_url(); ?>lgu/graphical_reports/interest_hobbies_report">Interest/Hobbies</a></li>
                    </ul><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-10">
                                    <form id="repForm" method="POST" action="<?= base_url(); ?>lgu/graphical_reports/interest_hobbies_report/filter">
                                        <div class="row">
                                            <div class="col-md-3">
