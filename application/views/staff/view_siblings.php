                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12"><br>
                            ...
                            <h4><label><?php echo $info->fName.' '.$info->mName.' '.$info->lName.' '.$info->ext ?>'s Siblings</label></h4>
                            <a href="<?= base_url(); ?>lgu/members" class="btn btn-warning pull-left">Back</a>&nbsp;
                            <a href="<?= base_url(); ?>lgu/members/view/siblings/add/<?= $id; ?>" class="btn btn-primary">Add</a><br><br>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url(); ?>lgu/members/edit/sibling/<?= $row->id; ?>" class="btn btn-success" title="Edit"><span class="ti-pencil-alt"></span></a>
