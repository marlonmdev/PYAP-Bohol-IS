            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?= base_url(); ?>lgu/graphical_reports/skills_report">Skills</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-10">
                                    <form id="repForm" method="POST" action="<?= base_url(); ?>lgu/graphical_reports/skills_report/filter">
                                        <div class="row">
                                            <div class="col-md-3">
                            ...
                            <div id="data">
                                ...
                                ?>
                                <div id='myChart' style="margin-top:20px;height:auto;width:100%;min-height:500px;"></div>
                                <br><br>
