            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active"><a href="<?= base_url(); ?>lgu/graphical_reports/age_brackets_report">Age Brackets</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                             <div class="row">
                                <div class="col-md-10">
                                    <form id="repForm" method="POST" action="<?= base_url(); ?>lgu/graphical_reports/age_brackets_report/filter">
                                        <div class="row">
                                            <div class="col-md-3">
                            ...
                            <div id="data">
                                ...
                                <?php 
                                    if($repType == 'Quarter'){
                                        ...
                                        echo "<center><h4>".$quarter." Quarter Age Brackets Report, CY ".$fYear."</h4></center>";
                                    }else{
                                        echo "<center><h4>Annual Age Brackets Report, CY ".$fYear."</h4></center>";
                                    }
                                ?>
                                ...
                                <div id='myChart' style="margin-top:20px;height:auto;width:100%;min-height:360px;"></div>
                                <br><br>
