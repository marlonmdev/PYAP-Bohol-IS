            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <ul class="nav nav-tabs">
                      ...
                      <li role="presentation" class="active"><a href="<?= base_url(); ?>lgu/tabular_reports/interest_hobbies">Interest/Hobbies</a></li>
                    </ul><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-10">
                                    <form id="repForm" method="POST" action="<?= base_url(); ?>lgu/tabular_reports/interest_hobbies/filter">
                                        <div class="row">
                                            <div class="col-md-3">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="7" class="text-center">REASON FOR DROPPING</th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                    if(empty($content)){   
                                        echo '<td colspan="8"><strong><h3 class="text-center">No Data Found..</h3></strong></td>'; 
                                    }elseif(!empty($content)){
                                        foreach($content as $row){
                                    ?>
                                     <tr>
                                        <td class="text-center" style="font-size:.9em;"><?= $row->brgy; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest1; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest2; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest3; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest4; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest5; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest6; ?></td>
                                        <td class="text-center"><?= $row->lgu_interest7; ?></td>
                                    </tr>
                                     <?php   
                                        }
                                        }
