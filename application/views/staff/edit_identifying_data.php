                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <form id="id_data" method="POST" action="<?= base_url(); ?>lgu/members/edit/identifying_data/update/<?= $row->mid; ?>" enctype="multipart/form-data">
                            <div class="row form-group">
                              ...
                              <div class="inp col-md-3">
                                <input type="file" name="userfile" class="dropify" data-height="150" data-max-file-size="3M" data-default-file="<?= base_url();?>members/thumbs/<?= $row->photo; ?>" accept="image/*">
                              </div>
                            </div>
                            <div class="row form-group">
                              <div class="inp col-md-3">
                            ...
                            <div class="row form-group">
                              ...
                              <div class="inp col-md-3">
                                ...
                                <input type="text" id="dob" name="dBirth" class="form-control" placeholder="Select Date" value="<?= $row->dBirth; ?>" autocomplete="off" required/>
                              </div>
                              <div class="inp col-md-3">
                                <label>Age</label>
                                <input type="number" id="age" name="age" class="form-control" value="<?= $row->age; ?>" minlength="2" placeholder="Age"/>
                              </div>
                              <div class="inp col-md-3">
                            ...
                            <input type="checkbox" id="sameB" name="sameB" class="form-check-input icheckbox_square-green" style="left:50px;"><span style="margin-left:15px;">Same as Address</span>
                            <div class="row form-group">
                              <div class="inp col-md-3">
                                <label>Barangay</label>
                            ...
                            <div class="row form-group">
                              ...
                              <div class="inp col-md-3">
                                ...
                                <input type="text" name="celNo" class="form-control" value="<?= $row->celNo; ?>" placeholder="Enter Cellphone No." minlength="11" maxlength="11" required/>
                              </div>
                            ...
                            <div class="row form-group">
                              ...
                              <div class="inp col-md-2">
                                <label>Age</label>
                                <input type="number" name="fathAge" class="form-control" value="<?= $row->fathAge; ?>" placeholder="Enter Age" minlength="2" maxlength="3" required/>
                              </div>
                              <div class="inp col-md-3">
                            ...
                            <div class="row form-group">
                              ...
                              <div class="inp col-md-2">
                                <label>Age</label>
                                <input type="text" name="mothAge" class="form-control" value="<?= $row->mothAge; ?>" placeholder="Enter Age" minlength="2" maxlength="3"/>
                              </div>
                              <div class="inp col-md-3">
                                <label>Occupation</label>
                              ...
                              <div class="inp col-md-3">
                                <label>Monthly Income</label>
                                <input type="number" name="mothIncome" class="form-control" value="<?= $row->mothIncome; ?>" placeholder="Enter Monthly Income"/>
                              </div>
                            </div>
